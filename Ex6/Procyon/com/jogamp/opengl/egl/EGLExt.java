...
public interface EGLExt
{
    ...
    long eglCreateSync64KHR(final long p0, final int p1, final PointerBuffer p2);
    
    boolean eglQueryDebugKHR(final int p0, final PointerBuffer p1);
    
    int eglLabelObjectKHR(final long p0, final int p1, final Buffer p2, final Buffer p3);
    
    long eglCreateSyncKHR(final long p0, final int p1, final IntBuffer p2);
    
    boolean eglDestroySyncKHR(final long p0, final long p1);
    
    int eglClientWaitSyncKHR(final long p0, final long p1, final int p2, final long p3);
    
    boolean eglGetSyncAttribKHR(final long p0, final long p1, final int p2, final IntBuffer p3);
    
    long eglCreateImageKHR(final long p0, final long p1, final int p2, final Buffer p3, final IntBuffer p4);
    
    boolean eglDestroyImageKHR(final long p0, final long p1);
    
    boolean eglLockSurfaceKHR(final long p0, final long p1, final IntBuffer p2);
    
    boolean eglUnlockSurfaceKHR(final long p0, final long p1);
    
    boolean eglQuerySurface64KHR(final long p0, final long p1, final int p2, final PointerBuffer p3);
    
    boolean eglSetDamageRegionKHR(final long p0, final long p1, final IntBuffer p2, final int p3);
    
    boolean eglSignalSyncKHR(final long p0, final long p1, final int p2);
    
    ByteBuffer eglCreateStreamKHR(final long p0, final IntBuffer p1);
    
    boolean eglDestroyStreamKHR(final long p0, final Buffer p1);
    
    boolean eglStreamAttribKHR(final long p0, final Buffer p1, final int p2, final int p3);
    
    boolean eglQueryStreamKHR(final long p0, final Buffer p1, final int p2, final IntBuffer p3);
    
    boolean eglQueryStreamu64KHR(final long p0, final Buffer p1, final int p2, final LongBuffer p3);
    
    boolean eglStreamConsumerGLTextureExternalKHR(final long p0, final Buffer p1);
    
    boolean eglStreamConsumerAcquireKHR(final long p0, final Buffer p1);
    
    boolean eglStreamConsumerReleaseKHR(final long p0, final Buffer p1);
    
    int eglGetStreamFileDescriptorKHR(final long p0, final Buffer p1);
    
    ByteBuffer eglCreateStreamFromFileDescriptorKHR(final long p0, final int p1);
    
    boolean eglQueryStreamTimeKHR(final long p0, final Buffer p1, final int p2, final LongBuffer p3);
    
    long eglCreateStreamProducerSurfaceKHR(final long p0, final long p1, final Buffer p2, final IntBuffer p3);
    
    boolean eglSwapBuffersWithDamageKHR(final long p0, final long p1, final IntBuffer p2, final int p3);
    
    int eglWaitSyncKHR(final long p0, final long p1, final int p2);
    
    int eglDupNativeFenceFDANDROID(final long p0, final long p1);
    
    boolean eglQuerySurfacePointerANGLE(final long p0, final long p1, final int p2, final PointerBuffer p3);
    
    boolean eglQueryDeviceAttribEXT(final Buffer p0, final int p1, final PointerBuffer p2);
    
    ByteBuffer eglQueryDeviceStringEXT(final Buffer p0, final int p1);
    
    boolean eglQueryDevicesEXT(final int p0, final PointerBuffer p1, final IntBuffer p2);
    
    boolean eglQueryDisplayAttribEXT(final long p0, final int p1, final PointerBuffer p2);
    
    boolean eglGetOutputLayersEXT(final long p0, final PointerBuffer p1, final PointerBuffer p2, final int p3, final IntBuffer p4);
    
    boolean eglGetOutputPortsEXT(final long p0, final PointerBuffer p1, final PointerBuffer p2, final int p3, final IntBuffer p4);
    
    boolean eglOutputLayerAttribEXT(final long p0, final Buffer p1, final int p2, final long p3);
    
    boolean eglQueryOutputLayerAttribEXT(final long p0, final Buffer p1, final int p2, final PointerBuffer p3);
    
    ByteBuffer eglQueryOutputLayerStringEXT(final long p0, final Buffer p1, final int p2);
    
    boolean eglOutputPortAttribEXT(final long p0, final Buffer p1, final int p2, final long p3);
    
    boolean eglQueryOutputPortAttribEXT(final long p0, final Buffer p1, final int p2, final PointerBuffer p3);
    
    ByteBuffer eglQueryOutputPortStringEXT(final long p0, final Buffer p1, final int p2);
    
    long eglGetPlatformDisplayEXT(final int p0, final Buffer p1, final IntBuffer p2);
    
    long eglCreatePlatformWindowSurfaceEXT(final long p0, final long p1, final Buffer p2, final IntBuffer p3);
    
    long eglCreatePlatformPixmapSurfaceEXT(final long p0, final long p1, final Buffer p2, final IntBuffer p3);
    
    boolean eglStreamConsumerOutputEXT(final long p0, final Buffer p1, final Buffer p2);
    
    boolean eglSwapBuffersWithDamageEXT(final long p0, final long p1, final IntBuffer p2, final int p3);
    
    long eglCreatePixmapSurfaceHI(final long p0, final long p1, final EGLClientPixmapHI p2);
    
    long eglCreateDRMImageMESA(final long p0, final IntBuffer p1);
    
    boolean eglExportDRMImageMESA(final long p0, final long p1, final IntBuffer p2, final IntBuffer p3, final IntBuffer p4);
    
    boolean eglExportDMABUFImageQueryMESA(final long p0, final long p1, final IntBuffer p2, final IntBuffer p3, final LongBuffer p4);
    
    boolean eglExportDMABUFImageMESA(final long p0, final long p1, final IntBuffer p2, final IntBuffer p3, final IntBuffer p4);
    
    boolean eglSwapBuffersRegionNOK(final long p0, final long p1, final int p2, final IntBuffer p3);
    
    boolean eglSwapBuffersRegion2NOK(final long p0, final long p1, final int p2, final IntBuffer p3);
    
    boolean eglQueryNativeDisplayNV(final long p0, final PointerBuffer p1);
    
    boolean eglQueryNativeWindowNV(final long p0, final long p1, final PointerBuffer p2);
    
    boolean eglQueryNativePixmapNV(final long p0, final long p1, final PointerBuffer p2);
    
    boolean eglPostSubBufferNV(final long p0, final long p1, final int p2, final int p3, final int p4, final int p5);
    
    long eglCreateStreamSyncNV(final long p0, final Buffer p1, final int p2, final IntBuffer p3);
    
    ByteBuffer eglCreateFenceSyncNV(final long p0, final int p1, final IntBuffer p2);
    
    boolean eglDestroySyncNV(final Buffer p0);
    
    boolean eglFenceNV(final Buffer p0);
    
    int eglClientWaitSyncNV(final Buffer p0, final int p1, final long p2);
    
    boolean eglSignalSyncNV(final Buffer p0, final int p1);
    
    boolean eglGetSyncAttribNV(final Buffer p0, final int p1, final IntBuffer p2);
