...
public abstract class ID
{
    ...
    public static String getPlatformName(final short n) {
        switch (n) {
            case 0: {
                return "Unicode";
            }
    ...
    public static String getEncodingName(final short n, final short n2) {
        if (n == 0) {
            switch (n2) {
                case 0: {
    ...
    public static String getLanguageName(final short n, final short n2) {
        if (n == 1) {
            switch (n2) {
                case 0: {
                    return "English";
    ...
    public static String getNameName(final short n) {
        switch (n) {
            case 0: {
