...
public final class GLES1ProcAddressTable extends ProcAddressTable
{
    ...
    public GLES1ProcAddressTable(final FunctionAddressResolver functionAddressResolver) {
        ...
        final Field field = AccessController.doPrivileged((PrivilegedAction<Field>)new PrivilegedAction<Field>() {
            ...
            public final Field run() {
                ...
                while (i < this.val$funcNamePermNum) {
                    ...
                    try {
                        final Field declaredField = GLES1ProcAddressTable.class.getDeclaredField(funcNamePermutation);
