...
public final class GLES3ProcAddressTable extends ProcAddressTable
{
    ...
    long _addressof_glEnableiOES;
    long _addressof_glDisableiOES;
    long _addressof_glBlendEquationiOES;
    long _addressof_glBlendEquationSeparateiOES;
    long _addressof_glBlendFunciOES;
    long _addressof_glBlendFuncSeparateiOES;
    long _addressof_glColorMaskiOES;
    long _addressof_glIsEnablediOES;
    long _addressof_glDrawElementsBaseVertexOES;
    long _addressof_glDrawRangeElementsBaseVertexOES;
    long _addressof_glDrawElementsInstancedBaseVertexOES;
    long _addressof_glMultiDrawElementsBaseVertexOES;
    long _addressof_glFramebufferTextureOES;
    long _addressof_glMapBuffer;
    long _addressof_glPrimitiveBoundingBoxOES;
    long _addressof_glMinSampleShadingOES;
    long _addressof_glPatchParameteriOES;
    long _addressof_glFramebufferTexture3D;
    long _addressof_glTexBufferOES;
    long _addressof_glTexBufferRangeOES;
    long _addressof_glTexStorage3DMultisampleOES;
    ...
    long _addressof_glBindFragDataLocationIndexedEXT;
    long _addressof_glBindFragDataLocationEXT;
    long _addressof_glGetProgramResourceLocationIndexEXT;
    long _addressof_glGetFragDataIndexEXT;
    long _addressof_glBufferStorageEXT;
    ...
    long _addressof_glEnableiEXT;
    long _addressof_glDisableiEXT;
    long _addressof_glBlendEquationiEXT;
    long _addressof_glBlendEquationSeparateiEXT;
    long _addressof_glBlendFunciEXT;
    long _addressof_glBlendFuncSeparateiEXT;
    long _addressof_glColorMaskiEXT;
    long _addressof_glIsEnablediEXT;
    long _addressof_glDrawElementsBaseVertexEXT;
    long _addressof_glDrawRangeElementsBaseVertexEXT;
    long _addressof_glDrawElementsInstancedBaseVertexEXT;
    long _addressof_glMultiDrawElementsBaseVertexEXT;
    long _addressof_glFramebufferTextureEXT;
    long _addressof_glMultiDrawArraysIndirectEXT;
    long _addressof_glMultiDrawElementsIndirectEXT;
    ...
    long _addressof_glPrimitiveBoundingBoxEXT;
    long _addressof_glRasterSamplesEXT;
    long _addressof_glTexPageCommitmentEXT;
    long _addressof_glPatchParameteriEXT;
    long _addressof_glTexBufferEXT;
    long _addressof_glTexBufferRangeEXT;
    ...
    long _addressof_glCopyBufferSubDataNV;
    ...
    long _addressof_glUniformMatrix2x3fvNV;
    long _addressof_glUniformMatrix3x2fvNV;
    long _addressof_glUniformMatrix2x4fvNV;
    long _addressof_glUniformMatrix4x2fvNV;
    long _addressof_glUniformMatrix3x4fvNV;
    long _addressof_glUniformMatrix4x3fvNV;
    long _addressof_glPolygonModeNV;
    ...
    long _addressof_glViewportArrayvNV;
    long _addressof_glViewportIndexedfNV;
    long _addressof_glViewportIndexedfvNV;
    long _addressof_glScissorArrayvNV;
    long _addressof_glScissorIndexedNV;
    long _addressof_glScissorIndexedvNV;
    long _addressof_glDepthRangeArrayfvNV;
    long _addressof_glDepthRangeIndexedfNV;
    long _addressof_glGetFloati_vNV;
    long _addressof_glEnableiNV;
    long _addressof_glDisableiNV;
    long _addressof_glIsEnablediNV;
    ...
    public GLES3ProcAddressTable(final FunctionAddressResolver functionAddressResolver) {
        ...
        final Field field = AccessController.doPrivileged((PrivilegedAction<Field>)new PrivilegedAction<Field>() {
            ...
            public final Field run() {
                ...
                while (i < this.val$funcNamePermNum) {
                    ...
                    try {
                        final Field declaredField = GLES3ProcAddressTable.class.getDeclaredField(funcNamePermutation);
