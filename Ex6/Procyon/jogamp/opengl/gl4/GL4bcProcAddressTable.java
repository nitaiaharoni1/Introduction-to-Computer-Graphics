...
public final class GL4bcProcAddressTable extends ProcAddressTable
{
    ...
    long _addressof_glBufferStorage;
    long _addressof_glClearTexImage;
    long _addressof_glClearTexSubImage;
    long _addressof_glBindBuffersBase;
    long _addressof_glBindBuffersRange;
    long _addressof_glBindTextures;
    long _addressof_glBindSamplers;
    long _addressof_glBindImageTextures;
    long _addressof_glBindVertexBuffers;
    long _addressof_glClipControl;
    long _addressof_glCreateTransformFeedbacks;
    long _addressof_glTransformFeedbackBufferBase;
    long _addressof_glTransformFeedbackBufferRange;
    long _addressof_glGetTransformFeedbackiv;
    long _addressof_glGetTransformFeedbacki_v;
    long _addressof_glGetTransformFeedbacki64_v;
    long _addressof_glCreateBuffers;
    long _addressof_glNamedBufferStorage;
    long _addressof_glNamedBufferData;
    long _addressof_glNamedBufferSubData;
    long _addressof_glCopyNamedBufferSubData;
    long _addressof_glClearNamedBufferData;
    long _addressof_glClearNamedBufferSubData;
    long _addressof_glMapNamedBuffer;
    long _addressof_glMapNamedBufferRange;
    long _addressof_glUnmapNamedBuffer;
    long _addressof_glFlushMappedNamedBufferRange;
    long _addressof_glGetNamedBufferParameteriv;
    long _addressof_glGetNamedBufferParameteri64v;
    long _addressof_glGetNamedBufferPointerv;
    long _addressof_glGetNamedBufferSubData;
    long _addressof_glCreateFramebuffers;
    long _addressof_glNamedFramebufferRenderbuffer;
    long _addressof_glNamedFramebufferParameteri;
    long _addressof_glNamedFramebufferTexture;
    long _addressof_glNamedFramebufferTextureLayer;
    long _addressof_glNamedFramebufferDrawBuffer;
    long _addressof_glNamedFramebufferDrawBuffers;
    long _addressof_glNamedFramebufferReadBuffer;
    long _addressof_glInvalidateNamedFramebufferData;
    long _addressof_glInvalidateNamedFramebufferSubData;
    long _addressof_glClearNamedFramebufferiv;
    long _addressof_glClearNamedFramebufferuiv;
    long _addressof_glClearNamedFramebufferfv;
    long _addressof_glClearNamedFramebufferfi;
    long _addressof_glBlitNamedFramebuffer;
    long _addressof_glCheckNamedFramebufferStatus;
    long _addressof_glGetNamedFramebufferParameteriv;
    long _addressof_glGetNamedFramebufferAttachmentParameteriv;
    long _addressof_glCreateRenderbuffers;
    long _addressof_glNamedRenderbufferStorage;
    long _addressof_glNamedRenderbufferStorageMultisample;
    long _addressof_glGetNamedRenderbufferParameteriv;
    long _addressof_glCreateTextures;
    long _addressof_glTextureBuffer;
    long _addressof_glTextureBufferRange;
    long _addressof_glTextureStorage1D;
    long _addressof_glTextureStorage2D;
    long _addressof_glTextureStorage3D;
    long _addressof_glTextureStorage2DMultisample;
    long _addressof_glTextureStorage3DMultisample;
    long _addressof_glTextureSubImage1D;
    long _addressof_glTextureSubImage2D;
    long _addressof_glTextureSubImage3D;
    long _addressof_glCompressedTextureSubImage1D;
    long _addressof_glCompressedTextureSubImage2D;
    long _addressof_glCompressedTextureSubImage3D;
    long _addressof_glCopyTextureSubImage1D;
    long _addressof_glCopyTextureSubImage2D;
    long _addressof_glCopyTextureSubImage3D;
    long _addressof_glTextureParameterf;
    long _addressof_glTextureParameterfv;
    long _addressof_glTextureParameteri;
    long _addressof_glTextureParameterIiv;
    long _addressof_glTextureParameterIuiv;
    long _addressof_glTextureParameteriv;
    long _addressof_glGenerateTextureMipmap;
    long _addressof_glBindTextureUnit;
    long _addressof_glGetTextureImage;
    long _addressof_glGetCompressedTextureImage;
    long _addressof_glGetTextureLevelParameterfv;
    long _addressof_glGetTextureLevelParameteriv;
    long _addressof_glGetTextureParameterfv;
    long _addressof_glGetTextureParameterIiv;
    long _addressof_glGetTextureParameterIuiv;
    long _addressof_glGetTextureParameteriv;
    long _addressof_glCreateVertexArrays;
    long _addressof_glDisableVertexArrayAttrib;
    long _addressof_glEnableVertexArrayAttrib;
    long _addressof_glVertexArrayElementBuffer;
    long _addressof_glVertexArrayVertexBuffer;
    long _addressof_glVertexArrayVertexBuffers;
    long _addressof_glVertexArrayAttribBinding;
    long _addressof_glVertexArrayAttribFormat;
    long _addressof_glVertexArrayAttribIFormat;
    long _addressof_glVertexArrayAttribLFormat;
    long _addressof_glVertexArrayBindingDivisor;
    long _addressof_glGetVertexArrayiv;
    long _addressof_glGetVertexArrayIndexediv;
    long _addressof_glGetVertexArrayIndexed64iv;
    long _addressof_glCreateSamplers;
    long _addressof_glCreateProgramPipelines;
    long _addressof_glCreateQueries;
    long _addressof_glGetQueryBufferObjecti64v;
    long _addressof_glGetQueryBufferObjectiv;
    long _addressof_glGetQueryBufferObjectui64v;
    long _addressof_glGetQueryBufferObjectuiv;
    long _addressof_glMemoryBarrierByRegion;
    long _addressof_glGetTextureSubImage;
    long _addressof_glGetCompressedTextureSubImage;
    ...
    long _addressof_glTextureBarrier;
    long _addressof_glPrimitiveBoundingBox;
    long _addressof_glGetTextureHandleARB;
    long _addressof_glGetTextureSamplerHandleARB;
    long _addressof_glMakeTextureHandleResidentARB;
    long _addressof_glMakeTextureHandleNonResidentARB;
    long _addressof_glGetImageHandleARB;
    long _addressof_glMakeImageHandleResidentARB;
    long _addressof_glMakeImageHandleNonResidentARB;
    long _addressof_glUniformHandleui64ARB;
    long _addressof_glUniformHandleui64vARB;
    long _addressof_glProgramUniformHandleui64ARB;
    long _addressof_glProgramUniformHandleui64vARB;
    long _addressof_glIsTextureHandleResidentARB;
    long _addressof_glIsImageHandleResidentARB;
    long _addressof_glVertexAttribL1ui64ARB;
    long _addressof_glVertexAttribL1ui64vARB;
    long _addressof_glGetVertexAttribLui64vARB;
    long _addressof_glCreateSyncFromCLeventARB;
    long _addressof_glDispatchComputeGroupSizeARB;
    ...
    long _addressof_glUniform1i64ARB;
    long _addressof_glUniform2i64ARB;
    long _addressof_glUniform3i64ARB;
    long _addressof_glUniform4i64ARB;
    long _addressof_glUniform1i64vARB;
    long _addressof_glUniform2i64vARB;
    long _addressof_glUniform3i64vARB;
    long _addressof_glUniform4i64vARB;
    long _addressof_glUniform1ui64ARB;
    long _addressof_glUniform2ui64ARB;
    long _addressof_glUniform3ui64ARB;
    long _addressof_glUniform4ui64ARB;
    long _addressof_glUniform1ui64vARB;
    long _addressof_glUniform2ui64vARB;
    long _addressof_glUniform3ui64vARB;
    long _addressof_glUniform4ui64vARB;
    long _addressof_glGetUniformi64vARB;
    long _addressof_glGetUniformui64vARB;
    long _addressof_glGetnUniformi64vARB;
    long _addressof_glGetnUniformui64vARB;
    long _addressof_glProgramUniform1i64ARB;
    long _addressof_glProgramUniform2i64ARB;
    long _addressof_glProgramUniform3i64ARB;
    long _addressof_glProgramUniform4i64ARB;
    long _addressof_glProgramUniform1i64vARB;
    long _addressof_glProgramUniform2i64vARB;
    long _addressof_glProgramUniform3i64vARB;
    long _addressof_glProgramUniform4i64vARB;
    long _addressof_glProgramUniform1ui64ARB;
    long _addressof_glProgramUniform2ui64ARB;
    long _addressof_glProgramUniform3ui64ARB;
    long _addressof_glProgramUniform4ui64ARB;
    long _addressof_glProgramUniform1ui64vARB;
    long _addressof_glProgramUniform2ui64vARB;
    long _addressof_glProgramUniform3ui64vARB;
    long _addressof_glProgramUniform4ui64vARB;
    ...
    long _addressof_glMultiDrawArraysIndirectCountARB;
    long _addressof_glMultiDrawElementsIndirectCountARB;
    long _addressof_glCurrentPaletteMatrixARB;
    long _addressof_glMatrixIndexubvARB;
    long _addressof_glMatrixIndexusvARB;
    long _addressof_glMatrixIndexuivARB;
    long _addressof_glMatrixIndexPointerARB;
    long _addressof_glMaxShaderCompilerThreadsARB;
    long _addressof_glFramebufferSampleLocationsfvARB;
    long _addressof_glNamedFramebufferSampleLocationsfvARB;
    long _addressof_glEvaluateDepthValuesARB;
    ...
    long _addressof_glBufferPageCommitmentARB;
    long _addressof_glNamedBufferPageCommitmentEXT;
    long _addressof_glNamedBufferPageCommitmentARB;
    long _addressof_glTexPageCommitmentARB;
    ...
    long _addressof_glWeightPointerARB;
    ...
    long _addressof_glBlendBarrier;
    ...
    long _addressof_glQueryObjectParameteruiAMD;
    ...
    long _addressof_glNamedBufferStorageEXT;
    long _addressof_glProgramUniform1dEXT;
    long _addressof_glProgramUniform2dEXT;
    long _addressof_glProgramUniform3dEXT;
    long _addressof_glProgramUniform4dEXT;
    long _addressof_glProgramUniform1dvEXT;
    long _addressof_glProgramUniform2dvEXT;
    long _addressof_glProgramUniform3dvEXT;
    long _addressof_glProgramUniform4dvEXT;
    long _addressof_glProgramUniformMatrix2dvEXT;
    long _addressof_glProgramUniformMatrix3dvEXT;
    long _addressof_glProgramUniformMatrix4dvEXT;
    long _addressof_glProgramUniformMatrix2x3dvEXT;
    long _addressof_glProgramUniformMatrix2x4dvEXT;
    long _addressof_glProgramUniformMatrix3x2dvEXT;
    long _addressof_glProgramUniformMatrix3x4dvEXT;
    long _addressof_glProgramUniformMatrix4x2dvEXT;
    long _addressof_glProgramUniformMatrix4x3dvEXT;
    ...
    long _addressof_glVertexArrayVertexAttribLOffsetEXT;
    long _addressof_glTexturePageCommitmentEXT;
    long _addressof_glVertexArrayVertexAttribDivisorEXT;
    ...
    long _addressof_glPolygonOffsetClampEXT;
    long _addressof_glProvokingVertexEXT;
    long _addressof_glRasterSamplesEXT;
    ...
    long _addressof_glApplyFramebufferAttachmentCMAAINTEL;
    long _addressof_glSyncTextureINTEL;
    long _addressof_glUnmapTexture2DINTEL;
    long _addressof_glMapTexture2DINTEL;
    long _addressof_glBeginPerfQueryINTEL;
    long _addressof_glCreatePerfQueryINTEL;
    long _addressof_glDeletePerfQueryINTEL;
    long _addressof_glEndPerfQueryINTEL;
    long _addressof_glGetFirstPerfQueryIdINTEL;
    long _addressof_glGetNextPerfQueryIdINTEL;
    long _addressof_glGetPerfCounterInfoINTEL;
    long _addressof_glGetPerfQueryDataINTEL;
    long _addressof_glGetPerfQueryIdByNameINTEL;
    long _addressof_glGetPerfQueryInfoINTEL;
    long _addressof_glBeginConditionalRenderNVX;
    long _addressof_glEndConditionalRenderNVX;
    long _addressof_glMultiDrawArraysIndirectBindlessNV;
    long _addressof_glMultiDrawElementsIndirectBindlessNV;
    long _addressof_glMultiDrawArraysIndirectBindlessCountNV;
    long _addressof_glMultiDrawElementsIndirectBindlessCountNV;
    long _addressof_glCreateStatesNV;
    long _addressof_glDeleteStatesNV;
    long _addressof_glIsStateNV;
    long _addressof_glStateCaptureNV;
    long _addressof_glGetCommandHeaderNV;
    long _addressof_glGetStageIndexNV;
    long _addressof_glDrawCommandsNV;
    long _addressof_glDrawCommandsAddressNV;
    long _addressof_glDrawCommandsStatesNV;
    long _addressof_glDrawCommandsStatesAddressNV;
    long _addressof_glCreateCommandListsNV;
    long _addressof_glDeleteCommandListsNV;
    long _addressof_glIsCommandListNV;
    long _addressof_glListDrawCommandsStatesClientNV;
    long _addressof_glCommandListSegmentsNV;
    long _addressof_glCompileCommandListNV;
    long _addressof_glCallCommandListNV;
    long _addressof_glSubpixelPrecisionBiasNV;
    long _addressof_glConservativeRasterParameterfNV;
    ...
    long _addressof_glFragmentCoverageColorNV;
    long _addressof_glCoverageModulationTableNV;
    long _addressof_glGetCoverageModulationTableNV;
    long _addressof_glCoverageModulationNV;
    ...
    long _addressof_glFramebufferSampleLocationsfvNV;
    long _addressof_glNamedFramebufferSampleLocationsfvNV;
    long _addressof_glResolveDepthValuesNV;
    ...
    long _addressof_glFramebufferTextureMultiviewOVR;
    ...
    public GL4bcProcAddressTable(final FunctionAddressResolver functionAddressResolver) {
        ...
        final Field field = AccessController.doPrivileged((PrivilegedAction<Field>)new PrivilegedAction<Field>() {
            ...
            public final Field run() {
                ...
                while (i < this.val$funcNamePermNum) {
                    ...
                    try {
                        final Field declaredField = GL4bcProcAddressTable.class.getDeclaredField(funcNamePermutation);
