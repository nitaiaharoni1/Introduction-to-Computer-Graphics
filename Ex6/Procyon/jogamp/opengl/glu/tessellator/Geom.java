...
class Geom
{
    ...
    static double EdgeCos(final GLUvertex glUvertex, final GLUvertex glUvertex2, final GLUvertex glUvertex3) {
        final double n = glUvertex2.s - glUvertex.s;
        final double n2 = glUvertex2.t - glUvertex.t;
        final double n3 = glUvertex3.s - glUvertex.s;
        final double n4 = glUvertex3.t - glUvertex.t;
        double n5 = n * n3 + n2 * n4;
        final double n6 = Math.sqrt(n * n + n2 * n2) * Math.sqrt(n3 * n3 + n4 * n4);
        if (n6 > 0.0) {
            n5 /= n6;
        }
        return n5;
