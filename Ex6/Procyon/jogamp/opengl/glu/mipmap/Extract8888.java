...
public class Extract8888 implements Extract
{
    ...
    public void extract(final boolean b, final ByteBuffer byteBuffer, final float[] array) {
        ...
        array[0] = ((n & 0xFFFFFFFFFF000000L) >> 24) / 255.0f;
        array[1] = ((n & 0xFF0000L) >> 16) / 255.0f;
        array[2] = ((n & 0xFF00L) >> 8) / 255.0f;
        array[3] = (n & 0xFFL) / 255.0f;
    }
    ...
    public void shove(final float[] array, final int n, final ByteBuffer byteBuffer) {
        ...
        byteBuffer.asIntBuffer().put(n, ((int)(array[0] * 255.0f + 0.5f) << 24 & 0xFF000000) | ((int)(array[1] * 255.0f + 0.5f) << 16 & 0xFF0000) | ((int)(array[2] * 255.0f + 0.5f) << 8 & 0xFF00) | ((int)(array[3] * 255.0f + 0.5f) & 0xFF));
    }
}
