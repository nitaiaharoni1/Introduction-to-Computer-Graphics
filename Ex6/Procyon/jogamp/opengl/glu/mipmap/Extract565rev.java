...
public class Extract565rev implements Extract
{
    ...
    public void shove(final float[] array, final int n, final ByteBuffer byteBuffer) {
        ...
        byteBuffer.asShortBuffer().put(n, (short)(((int)(array[0] * 31.0f + 0.5f) & 0x1F) | ((int)(array[1] * 63.0f + 0.5f) << 5 & 0x7E0) | ((int)(array[2] * 31.0f + 0.5f) << 11 & 0xF800)));
    }
}
