...
public class Extract4444 implements Extract
{
    ...
    public void extract(final boolean b, final ByteBuffer byteBuffer, final float[] array) {
        ...
        array[0] = ((n & 0xF000) >> 12) / 15.0f;
        array[1] = ((n & 0xF00) >> 8) / 15.0f;
        array[2] = ((n & 0xF0) >> 4) / 15.0f;
        array[3] = (n & 0xF) / 15.0f;
    }
    ...
    public void shove(final float[] array, final int n, final ByteBuffer byteBuffer) {
        ...
        byteBuffer.asShortBuffer().put(n, (short)(((int)(array[0] * 15.0f + 0.5f) << 12 & 0xF000) | ((int)(array[1] * 15.0f + 0.5f) << 8 & 0xF00) | ((int)(array[2] * 15.0f + 0.5f) << 4 & 0xF0) | ((int)(array[3] * 15.0f + 0.5f) & 0xF)));
    }
}
