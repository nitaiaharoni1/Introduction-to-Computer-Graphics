...
public class Track implements IRenderable {
	...
	public Track() {
		// Initialize the track. We did it for you.
	...
	public void init(GL2 gl) {
		// Initialize the track segments. We already did it for you.
	...
	public void destroy(GL2 gl) {
		// Destroy the track segments. We already did it for you.
	...
	public void changeTrack(GL2 gl) {
		// Change the current track by switch the current and next track.
